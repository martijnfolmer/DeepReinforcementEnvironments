...
from environments.Env_Temperature_static import Environment



"""
    This is the script which uses deep q learning to solve the Static Temperature environment, in which the 
    system must try to raise or lower the temperature to approach a given temperature (38 C in this case).
    ...
    Running this script will train a model on the static temperature environment and save a video every X number of 
    ...
    such as Cart which do use the more complete version of deep q-learning)
...
class DeepAgent:
    ...
    def __init__(self):
        ...
        # Memory
        self.replay_memory = deque(maxlen=200)       # the memory we replay (First in - First out)
        ...
        # For testing states
        self.test_states = [0, 25, 75, 100]     # what the state is for every
        self.video_every_episode = 10            # How often we create a video
    ...
    def test(self, episode_num):
        ...
        for test_state in self.test_states:
            ...
            self.environment.state[0] = test_state              # set our test state
    ...
    def RunDeepQLearning(self):
        ...
        # Save the model
        self.model.save('Temperature_static_final_model')
        ...
        plt.savefig('History_of_training_static_temperature.png')
